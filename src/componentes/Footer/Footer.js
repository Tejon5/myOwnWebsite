        ...
        <footer className="footer">
            ...
            <div className="footer-container">
                ...
                <div className="footer-contact">
                    <h3>Contact Me</h3>
                    <p className="data-contact">👉📱 <a className="data-contact-cv" href={invite} rel="noreferrer" target="_blank">{mobile} </a> </p>
                    <p className="data-contact">👉📧 <a className="data-contact-cv" href="mailto:juan.villalba08@gmail.com">{email}</a></p>
